		  ...
		  <div class="box">
            ...
            <?php
                if(isset($_POST['submit'])){
                    $uploaddir = "assets/images/Attorneys/";
                    ...
                    $desc = $_POST['pdesc'];
                    // echo $_POST['pname'];
                    $insert = "INSERT INTO `tbl_lawyer`(`pro_name`, `pro_description`, `pro_cat`, `pro_availability`, `pro_qty`, `pro_price`, `pro_image`) VALUES ('$pname','$desc','$cat','$avail','$qty','$price','$pro_images')";
                    mysqli_query($conn,$insert);
